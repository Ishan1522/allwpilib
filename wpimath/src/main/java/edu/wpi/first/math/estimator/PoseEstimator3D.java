 ...
 */
public class PoseEstimator3D<T extends WheelPositions<T>> {
   ...
   *     PoseEstimator#updateWithTime(double,Rotation3d,WheelPositions)} then you must use a
  ...
  public void addVisionMeasurement(Pose3d visionRobotPoseMeters, double timestampSeconds) {
    ...
    var scaledTwist =
        new Twist3d(k_times_twist.get(0, 0), k_times_twist.get(1, 0), k_times_twist.get(2, 0));
  ...
  private class InterpolationRecord implements Interpolatable<InterpolationRecord> {
     ...
     * @param wheelPositions The current encoder readings.
     */
    private InterpolationRecord(Pose3d poseMeters, Rotation3d gyro, T wheelPositions) {
    ...
    public InterpolationRecord interpolate(InterpolationRecord endValue, double t) {
      if (t < 0) {
        ...
        Twist3d twist = m_kinematics.toTwist3d(wheelPositions, wheelLerp);
